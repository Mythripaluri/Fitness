...
# Generator function for video streaming (Right Curl)
def generate_frames(target_reps, target_sets):
    global reps, sets, direction, last_audio_message, message_timer, final_message_shown
    start_time = time.time()  # Track exercise duration
